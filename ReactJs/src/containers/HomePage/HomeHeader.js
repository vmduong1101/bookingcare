                    ...
                    <div className="home-header-content">
                        <div className="left-content">
                                ...
                                <div className="header-logo">
                                    <img src={logo} alt="" onClick={() => this.returnToHome()}/>
                                </div>
                        </div>
                        ...
                        <div className="right-content">
                            <div className="support"> <i className="fas fa-question-circle"><span><FormattedMessage id="homeheader.support" /></span></i> </div>
